...
SVE_STRINGS.SCANNING_HEADERS = "Effectue la vérification... (Scan de l'entête des messages en cours...)";
...
SVE_STRINGS.DK_CONTACTING_SERVER = "Effectue la vérification... (Appel du serveur de vérification DomainKeys...)";
...
SVE_STRINGS.ADDRESS_KNOWN = "Adresse est connue de vous.";
SVE_STRINGS.DOMAIN_KNOWN = "Domaine est connue de vous.";
SVE_STRINGS.SENDER_UNKNOWN = "Expéditeur est inconnu pour vous.";
...
SVE_STRINGS.LOCALSENDER = function(domain) { return "Emetteurs affirmant votre propre nom de domaine <" + domain + "> ne peut pas être vérifiée."; };
...
SVE_STRINGS.CHECKING_RBLS1 = "Effectue la vérification... (Vérification de l'expéditeur dans les listes de SURBL/Spamhaus et hameçonnage...)";
